     ...
     <HeroSection />
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <span className="text-blue-600">Unlock</span> Your Career Potential  with Powerful Features
          </h2>
      ...
      <section className="w-full py-12 md:py-24 bg-muted/50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto text-center">
            <div className="flex flex-col items-center justify-center space-y-2">
              ...
              <p className="text-white font-bold">Industry Expertise</p>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
              <h3 className="text-4xl font-bold text-blue-600">2000+</h3>
              <p className="text-white font-bold">Interview Mastery Toolkit</p>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
              <h3 className="text-4xl font-bold text-blue-600">99%</h3>
              <p className="text-white font-bold">Hiring Success</p>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
              <h3 className="text-4xl font-bold text-blue-600">24/7</h3>
              <p className="text-white font-bold">AI Career Mentor</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold mb-4">Your Success Path</h2>
            <p className="text-muted-foreground">
            Follow these four easy steps to boost your career
            </p>
          </div>
